                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-3">
                                ...
                                <h4>{{ number_format($channelSubscriptions) }} subscribers</h4>
                                <p>Latest upload: {{ $latestUpload }}</p>
                                ...
                                <section class="audio-player card mt-3">
                                    <div class="card bg-dark">
                                        ...
                                        <ul class="playlist list-group list-group-flush">
                                            <li class="list-group-item"><a href="{{ url('/storage', $podcast->audio->audio_file_name . '.' . $podcast->audio->audio_file_extension) }}" download>Download {{ $podcast->audio->audio_file_name . '.' . $podcast->audio->audio_file_extension }}</a></li>
